...
```
  ...
  --datadir value                     Data directory for the databases and keystore (default: "/Users/kelby/Library/Ethereum")
...
```
  ...
  --ethash.dagdir value               Directory to store the ethash mining DAGs (default: "/Users/kelby/Library/Ethash")
